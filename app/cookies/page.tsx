    ...
    <>
      <section className="relative overflow-hidden border-b border-ink bg-paper">
        ...
        <div className="wrap relative py-14 sm:py-16">
          <Breadcrumb items={[{ href: "/", label: "Home" }, { label: "Cookies" }]} />
          <p className="eyebrow mt-8">COOKIE_PREFERENCES</p>
          <h1 className="display mt-4 max-w-3xl text-balance text-4xl sm:text-6xl">
            You decide what we remember.
          </h1>
          <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-ink/70">
            Essential cookies keep the archive running. Everything else is opt-in and
            saved locally in your browser — change it any time.
          </p>
        </div>
      </section>
